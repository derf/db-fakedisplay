function reload_app(){$.get(window.location.href,{ajax:1},function(e){$("div.app > ul").html(e),dbf_reg_handlers(),setTimeout(reload_app,6e4)}).fail(function(){setTimeout(reload_app,1e4)})}function dbf_reg_handlers(){$("div.app > ul > li").click(function(){var e=$(this),n=e.data("routeprev").split("|"),r=e.data("routenext").split("|"),a=e.data("moreinfo").split("|");$(".moreinfo").each(function(){var i=$(this);$(".moreinfo .train-line").removeClass("bahn sbahn fern ext").addClass(e.data("linetype")),$(".moreinfo .train-line").text(e.data("line")),$(".moreinfo .train-no").text(e.data("no")),$(".moreinfo .train-origin").text(e.data("from")),$(".moreinfo .train-dest").text(e.data("to")),$(".moreinfo .minfo").text(""),$(".moreinfo .mfooter").html(""),$(".moreinfo .verbose").html(""),$(".moreinfo .mroute").html(""),$(".moreinfo ul").html("");var t="";if(""!=e.data("arrival")?t+='<div><div class="arrival">An: '+e.data("arrival")+"</div></div>":t+='<div><div class="arrival"></div></div>',""!=e.data("platform")?t+='<div><div class="platform">Gleis '+e.data("platform")+"</div></div>":t+='<div><div class="platform"></div></div>',""!=e.data("departure")?t+='<div><div class="departure">Ab: '+e.data("departure")+"</div></div>":t+='<div><div class="departure"></div></div>',$(".moreinfo .mfooter").append('<div class="dataline">'+t+"</div>"),0==$(".moreinfo .loading").length&&$(".moreinfo .mfooter").append('<div class="loading">Lade Daten, bitte warten...</div>'),""!=e.data("moreinfo")){var l="";for(var s in a)l+="<li>"+a[s]+"</li>";$(".moreinfo .mfooter").append("Meldungen: <ul>"+l+"</ul>")}var h="";if(""!=e.data("routeprev"))for(var s in n)h+="<li>"+n[s]+"</li>";if(h+="<li><strong>"+document.title+"</strong></li>",""!=e.data("routenext"))for(var s in r)h+="<li>"+r[s]+"</li>";$(".moreinfo .mfooter").append('Fahrtverlauf: <ul class="mroute">'+h+"</ul>"),$.get(window.location.href,{train:e.data("train"),ajax:1},function(e){$(".moreinfo").html(e)}).fail(function(){$(".moreinfo .mfooter").append("Der Zug ist abgefahren (Zug nicht gefunden)")}),i.removeClass("collapsed-moreinfo"),i.addClass("expanded-moreinfo")})})}$(function(){
