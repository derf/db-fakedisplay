function reload_app(){$.get(window.location.href,{ajax:1},function(e){$("div.app > ul").html(e),dbf_reg_handlers(),setTimeout(reload_app,6e4)}).fail(function(){setTimeout(reload_app,1e4)})}function dbf_reg_handlers(){$("div.app > ul > li").click(function(){const e=$(this),n=e.data("routeprev").split("|"),r=e.data("routenext").split("|"),a=e.data("moreinfo").split("|"),i=window.location.href,t=$("div.app").data("station");history.pushState({page:"traindetail",train:e.data("no")},"test","/z/"+e.data("train")+"/"+t),$(".moreinfo").each(function(){var t=$(this);$(".moreinfo .train-line").removeClass("bahn sbahn fern ext").addClass(e.data("linetype")),$(".moreinfo .train-line").text(e.data("line")),$(".moreinfo .train-no").text(e.data("no")),$(".moreinfo .train-origin").text(e.data("from")),$(".moreinfo .train-dest").text(e.data("to")),$(".moreinfo .minfo").text(""),$(".moreinfo .mfooter").html(""),$(".moreinfo .verbose").html(""),$(".moreinfo .mroute").html(""),$(".moreinfo ul").html("");var l="";if(""!=e.data("arrival")?l+='<div><div class="arrival">An: '+e.data("arrival")+"</div></div>":l+='<div><div class="arrival"></div></div>',""!=e.data("platform")?l+='<div><div class="platform">Gleis '+e.data("platform")+"</div></div>":l+='<div><div class="platform"></div></div>',""!=e.data("departure")?l+='<div><div class="departure">Ab: '+e.data("departure")+"</div></div>":l+='<div><div class="departure"></div></div>',$(".moreinfo .mfooter").append('<div class="dataline">'+l+"</div>"),0==$(".moreinfo .loading").length&&$(".moreinfo .mfooter").append('<div class="loading">Lade Daten, bitte warten...</div>'),""!=e.data("moreinfo")){var s="";for(var h in a)s+="<li>"+a[h]+"</li>";$(".moreinfo .mfooter").append("Meldungen: <ul>"+s+"</ul>")}var o="";if(""!=e.data("routeprev"))for(var h in n)o+="<li>"+n[h]+"</li>";if(o+="<li><strong>"+document.title+"</strong></li>",""!=e.data("routenext"))for(var h in r)o+="<li>"+r[h]+"</li>";$(".moreinfo .mfooter").append('Fahrtverlauf: <ul class="mroute">'+o+"</ul>"),$.get(i,{train:e.data("train"),ajax:1},function(e){$(".moreinfo").html(e)}).fail(function(){$(".moreinfo .mfooter").append("Der Zug ist abgefahren (Zug nicht gefunden)")}),t.removeClass("collapsed-moreinfo"),t.addClass("expanded-moreinfo")})})}$(function(){
